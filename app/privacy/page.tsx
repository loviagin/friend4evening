            ...
            <div className={styles.container}>
                ...
                <section className={styles.section}>
                    ...
                    <div className={styles.content}>
                        ...
                        <ul className={styles.list}>
                            ...
                            <li>{t('sections.2.list.item4')}</li>
                            <li>{t('sections.2.list.item5')}</li>
                            <li>{t('sections.2.list.item6')}</li>
                        </ul>
                        <p className={styles.paragraph}>
                ...
                <section className={styles.section}>
                    ...
                    <div className={styles.content}>
                        ...
                        <p className={styles.paragraph}>
                            <strong>4.3.</strong> {t('sections.4.item3')}
                        </p>
                        <ul className={styles.list}>
                        ...
                        <p className={styles.paragraph}>
                            <strong>4.4.</strong> {t('sections.4.item4')}
                        </p>
                    </div>
                </section>
                ...
                <section className={styles.section}>
                    ...
                    <div className={styles.content}>
                        ...
                        <ul className={styles.list}>
                            <li>{t('sections.6.list.item1')}</li>
                            <li>{t('sections.6.list.item2')}</li>
                            <li>{t('sections.6.list.item3')}</li>
                            <li>{t('sections.6.list.item4')}</li>
                        </ul>
                        <p className={styles.paragraph}>
                ...
                <section className={styles.section}>
                    ...
                    <div className={styles.content}>
                        <p className={styles.paragraph}>
                            {t('sections.9.text')} <Link href="mailto:Friends4Evening@lovigin.com" className={styles.link}>Friends4Evening@lovigin.com</Link>
                        </p>
                    </div>
                </section>
