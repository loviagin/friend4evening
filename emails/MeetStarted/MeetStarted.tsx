import styles from './MeetStarted.module.css'

export type MeetStartedEmail = {
    userName: string,
    meetId: string,
    meetTitle: string,
    meetDate: Date,
...
export function MeetStarted({ userName, meetId, meetTitle, meetDate, meetLocation, meetDescription }: MeetStartedEmail) {
            ...
            <body className={styles.emailBody}>
                <div className={styles.container}>
                    ...
                    <p className={styles.paragraph}>
                        Привет, {userName}!<br />
                        Ваша встреча уже началась. Приятного времяпрепровождения!
                    </p>

                    <div className={styles.successBox}>
                        <h2 className={styles.successTitle}>✨ Встреча активна</h2>
                        <p className={styles.paragraph} style={{ margin: '0.5rem 0', fontSize: '1rem' }}>
                            Время встречи наступило. Надеемся, вы хорошо проведете время!
                        </p>
                    </div>
                    ...
                    <p className={styles.infoText}>
                        Желаем вам отлично провести время! Не забудьте оставить отзыв после встречи.
                    </p>
