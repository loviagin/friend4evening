import styles from './InvitationAccepted.module.css'

export type InvitationAcceptedEmail = {
...
export function InvitationAccepted({ organizerName, userName, meetId, meetTitle, meetDate, meetLocation, meetDescription }: InvitationAcceptedEmail) {
            ...
            <body className={styles.emailBody}>
                <div className={styles.container}>
                    ...
                    <p className={styles.paragraph}>
                        ...
                        {userName} принял(а) ваше приглашение на встречу.
                    </p>

                    <div className={styles.successBox}>
                        <h2 className={styles.successTitle}>✅ Участник присоединился</h2>
                        <p className={styles.paragraph} style={{ margin: '0.5rem 0', fontSize: '1rem' }}>
                            {userName} теперь является участником встречи.
                        </p>
                    </div>
                    ...
                    <p className={styles.infoText}>
                        Вы можете просмотреть список всех участников встречи на странице встречи.
                    </p>
