import styles from './InvitationDeclined.module.css'

export type InvitationDeclinedEmail = {
...
export function InvitationDeclined({ organizerName, userName, meetTitle, meetDate, meetLocation, meetDescription }: InvitationDeclinedEmail) {
            ...
            <body className={styles.emailBody}>
                <div className={styles.container}>
                    ...
                    <p className={styles.paragraph}>
                        Привет, {organizerName}!<br />
                        К сожалению, {userName} отклонил(а) ваше приглашение на встречу.
                    </p>

                    <div className={styles.warningBox}>
                        <h2 className={styles.warningTitle}>❌ Приглашение не принято</h2>
                        <p className={styles.paragraph} style={{ margin: '0.5rem 0', fontSize: '1rem' }}>
                            Не расстраивайтесь! Вы можете пригласить других пользователей на встречу.
                        </p>
                    </div>
                    ...
                    <div className={styles.buttonContainer}>
                        <a href={`${base}/account/meets`} className={styles.button}>
                            Посмотреть другие встречи
                        </a>
                    </div>

                    <p className={styles.infoText}>
                        Вы можете найти других участников для вашей встречи на нашей платформе.
                    </p>
