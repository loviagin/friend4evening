import styles from './ApplicationDeclined.module.css'

export type ApplicationDeclinedEmail = {
    userName: string,
    meetTitle: string,
    meetDate: Date,
...
export function ApplicationDeclined({ userName, meetTitle, meetDate, meetLocation, meetDescription }: ApplicationDeclinedEmail) {
            ...
            <body className={styles.emailBody}>
                <div className={styles.container}>
                    ...
                    <p className={styles.paragraph}>
                        Привет, {userName}!<br />
                        К сожалению, ваша заявка на участие во встрече была отклонена организатором.
                    </p>

                    <div className={styles.warningBox}>
                        <h2 className={styles.warningTitle}>❌ Заявка не принята</h2>
                        <p className={styles.paragraph} style={{ margin: '0.5rem 0', fontSize: '1rem' }}>
                            Не расстраивайтесь! Вы можете найти другие интересные встречи на нашей платформе.
                        </p>
                    </div>
                    ...
                    <p className={styles.infoText}>
                        На нашей платформе много интересных встреч. Удачи в поиске!
                    </p>
