import styles from './MeetInvitation.module.css'

export type MeetInvitationEmail = {
    userName: string,
...
export function MeetInvitation({ userName, organizerName, meetId, meetTitle, meetDate, meetLocation, meetDescription }: MeetInvitationEmail) {
        ...
        <html>
            <head>
                <style dangerouslySetInnerHTML={{
                    ...
                    .${styles.divider} {
                        border: none;
                        border-top: 2px solid rgba(70, 108, 149, 0.3);
                        margin: 2rem auto;
                        max-width: 600px;
                    }
                    .${styles.paragraph} {
                    ...
                    .${styles.invitationBox} {
                        background: rgba(70, 108, 149, 0.1);
                        border: 2px solid #466C95;
                        border-radius: 15px;
                        padding: 1.5rem;
                        margin: 1.5rem 2rem;
                    }
            ...
            <body className={styles.emailBody}>
                <div className={styles.container}>
                    ...
                    <p className={styles.paragraph}>
                        Привет, {userName}!<br />
                        {organizerName} пригласил(а) вас на встречу.
                    </p>

                    <div className={styles.invitationBox}>
                        <h2 className={styles.invitationTitle}>📨 Новое приглашение</h2>
                        <p className={styles.paragraph} style={{ margin: '0.5rem 0', fontSize: '1rem' }}>
                            Вы можете принять или отклонить приглашение на странице встречи.
                        </p>
                    </div>
                    ...
                    <p className={styles.infoText}>
                        Не забудьте ответить на приглашение до начала встречи!
                    </p>
